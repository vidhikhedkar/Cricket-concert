            ...
            <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="relative w-full max-w-85 sm:max-w-125 md:max-w-212.5 h-95 sm:h-110 md:h-135 mx-auto">
                            ...
                            <div className="relative w-40 h-40 sm:w-50 sm:h-50 md:w-55 md:h-55 bg-linear-to-b from-blue-50/60 to-white/90 rounded-full p-1.5 sm:p-2.5 shadow-2xl shadow-blue-500/10 border border-blue-100/60 flex items-center justify-center group-hover:scale-105 group-hover:shadow-[0_10px_40px_rgba(59,130,246,0.35)] transition-all duration-300">
                                <div className="w-full h-full bg-white rounded-full p-2.5 sm:p-4 md:p-6 shadow-inner border border-slate-200 flex flex-col items-center justify-center">
                                    <img
                                        src={trophy}
                                        alt="WCC Trophy"
                                        className="h-16 sm:h-20 md:h-32 object-contain mb-1 sm:mb-2 md:mb-3 group-hover:scale-110 transition-transform duration-300"
                                    />
                    ...
                    <div className="absolute top-[0%] sm:top-[2%] left-1/2 -translate-x-1/2 animate-float-slow z-10">
                        <div className="group relative">
                            <div className="absolute -inset-2 bg-blue-400/40 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white rounded-full p-1.5 sm:p-2 shadow-lg border border-blue-100/60 flex items-center justify-center group-hover:scale-125 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all duration-300">
                                <img
                                    src={WCC3}
                                    alt="Partner Logo"
                    ...
                    <div className="absolute top-[16%] sm:top-[20%] left-[4%] sm:left-[10%] md:left-[16%] animate-float-reverse z-10">
                        <div className="group relative">
                            <div className="absolute -inset-3 bg-blue-400/40 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative w-15 h-15 sm:w-20 sm:h-20 md:w-28 md:h-28 bg-white rounded-full p-2 sm:p-3 shadow-xl border border-slate-100 flex items-center justify-center group-hover:scale-120 group-hover:shadow-[0_0_35px_rgba(59,130,246,0.5)] transition-all duration-300">
                                <img
                                    src={WCC2}
                                    alt="Partner Logo"
                    ...
                    <div className="absolute top-[15%] sm:top-[18%] right-[6%] sm:right-[12%] md:right-[18%] animate-float-slow z-10">
                        <div className="group relative">
                            <div className="absolute -inset-3 bg-blue-400/40 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative w-13 h-13 sm:w-18 sm:h-18 md:w-26 md:h-26 bg-white rounded-full p-1.5 sm:p-3 shadow-xl border border-slate-100 flex items-center justify-center group-hover:scale-120 group-hover:shadow-[0_0_35px_rgba(59,130,246,0.5)] transition-all duration-300">
                                <img
                                    src={WCC4}
                                    alt="Partner Logo"
                                    className="w-full h-full object-contain"
                    ...
                    <div className="absolute top-[58%] right-[2%] sm:right-[5%] md:right-[9%] animate-float-reverse z-10">
                        <div className="group relative">
                            <div className="absolute -inset-2 bg-blue-400/40 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative w-10 h-10 sm:w-14 sm:h-14 md:w-18 md:h-18 bg-white rounded-full p-1.5 sm:p-2.5 shadow-lg border border-slate-100 flex items-center justify-center group-hover:scale-125 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all duration-300">
                                <img
                                    src={WCC5}
                                    alt="Partner Logo"
                                    className="w-full h-full object-contain"
                    ...
                    <div className="absolute top-[55%] left-[2%] sm:left-[4%] md:left-[8%] animate-float-slow z-10">
                        <div className="group relative">
                            <div className="absolute -inset-2 bg-blue-400/40 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative w-11 h-11 sm:w-15 sm:h-15 md:w-20 md:h-20 bg-white rounded-full p-1.5 sm:p-2.5 shadow-lg border border-slate-100 flex items-center justify-center group-hover:scale-125 group-hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] transition-all duration-300">
                                <img
                                    src={WCC1}
                                    alt="Partner Logo"
                                    className="w-full h-full object-contain"
                    ...
                    <div className="absolute bottom-[4%] sm:bottom-[6%] left-[18%] sm:left-[22%] md:left-[27%] animate-float-reverse z-10">
                        <div className="group relative">
                            <div className="absolute -inset-3 bg-blue-400/40 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative w-12 h-12 sm:w-18 sm:h-18 md:w-26 md:h-26 bg-white rounded-full p-1.5 sm:p-3 shadow-xl border border-slate-100 flex items-center justify-center group-hover:scale-120 group-hover:shadow-[0_0_35px_rgba(59,130,246,0.5)] transition-all duration-300">
                                <img
                                    src={WCC6}
                                    alt="Partner Logo"
                                    className="w-full h-full object-contain"
                    ...
                    <div className="absolute bottom-[2%] sm:bottom-[4%] right-[16%] sm:right-[20%] md:right-[25%] animate-float-slow z-10">
                        <div className="group relative">
                            <div className="absolute -inset-3 bg-blue-400/30 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                            <div className="relative w-14 h-14 sm:w-22 sm:h-22 md:w-32 md:h-32 bg-[#0B192C] text-white rounded-full shadow-2xl flex flex-col items-center justify-center p-1 sm:p-2 md:p-3 border-2 border-blue-400/20 group-hover:scale-115 group-hover:shadow-[0_0_40px_rgba(59,130,246,0.6)] transition-all duration-300">
